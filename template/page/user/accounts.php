          ...
          <div class="container px-6 mx-auto grid">
            ...
            <a class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="/u/create_account" onclick="document.querySelector('#backdrop-loading').style.visibility = 'visible';document.querySelector('#backdrop-loading').style.opacity = '1';">
                  Create Account
                </a><br>
           <!--  CTA
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  <thead>
                    ...
                    >
                      <th class="px-4 py-3"><?= $this->base->text('id', 'table') ?></th>
                  ...
                  <?php if (count($list) > 0): ?>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-sm">
                        <a href="<?= base_url().'u/view_account/'.$item['account_username'] ?>" onclick="changelink('<?= base_url().'u/view_account/'.$item['account_username'] ?>');return false;" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"><i class="fa <?= $btn[0] ?> me-1"></i> <?= $this->base->text('manage', 'button') ?></a></td>
                      </td>
                    </tr>
               <?php $count += 1; ?>
						<?php endforeach; ?>
