...
<html>
<head>
	<title>SSLs.com - <?= $this->base->get_hostname() ?></title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="refresh" content="0; url='https://ssls.sjv.io/kjxqxN'" />
	...
	<div class="page page-center">
		<div class="container text-center">
	        ...
	        <div class="empty-header"><i class="fa fa-sync fa-spin"></i></div>
		        ...
		        <button onclick="location.href = 'https://ssls.sjv.io/kjxqxN'" hidden="true" id="button"></button>
	        </div>
		</div>
	</div>
