<div class="container-xl">
	...
	<?php if (count($list) > 2): ?>
		<div class="alert alert-danger"><?= $this->base->text('account_limit', 'paragraph') ?> <a href="https://ifastnet.com/portal/aff.php?aff=29421" target="_blank"><?= $this->base->text('premium_hosting', 'heading') ?></a> <?= $this->base->text('better_service', 'paragraph') ?></div>
	<?php endif ?>
