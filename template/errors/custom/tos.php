	...
	<div class="page page-center">
		<div class="container-narrow py-4">
			<div class="text-center mb-2">
				<a href="." class="navbar-brand navbar-brand-autodark"><img src="https://i.imgur.com/zEX7mZn.png" height="36" alt=""></a>
			</div>
						...
						<div class="tabs pb-3">
						 ...
						 <div id="Terms" class="tab-content">
						 	<h2>1. ACCEPTANCE OF TERMS</h2>
									...
									<p>Registration Data and certain other information about you is subject to our Privacy Policy. For more information, see our full privacy policy at https://app.spookhost.eu.org/e/tos/?option=privacy , You understand that through your use of the Service you consent to the collection and use (as set forth in the Privacy Policy) of this i`nformation, including the transfer of this information to the United States and/or other countries for storage, processing and use by <?= $this->base->get_hostname()?> and its affiliates.
									...
									<p><strong>Please report any violations of the TOS to abuse@spookhost.eu.org.</strong></p>
						 </div>
						 <div id="Policy" class="tab-content">
						 	<h2><?= $this->base->get_hostname()?> Privacy Statement</h2>
			            	<p><?= $this->base->get_hostname()?> cares about and respects your privacy.  For this reason, we collect and use personal data only as it might be needed for us to deliver to you our products, services and websites (collectively, our "Services"). Your personal data includes information such as:</p>
							...
							<p>If at any time you have questions about our practices or any of your rights described below, you may reach our Data Protection Officer ("DPO") and our dedicated team by contacting us at <a href="mailto:support@spookhost.eu.org">support@spookhost.eu.org</a>.  This inbox is actively monitored and managed so that we can provide you with information you can confidently trust.</p>
							...
							<p>You may also update your subscription preferences with respect to receiving communications from us and/or our partners by making a support ticket at support@spookhost.eu.org or by using the support links in your control panel. </p>
							...
							<p>If you make use of a service that allows you to import contacts (e.g. using email marketing services to send emails on your behalf), we will only use the contacts and any other personal information needed for the requested service. If you believe that anyone has provided us with your personal information and you would like to request that it be removed from our database, please contact us at support@spookhost.eu.org</p>
							...
							<p>To easily access, view, update, delete, or port your personal data (where available), or to update your subscription preferences, please sign into your Account and visit "Edit Account Details." Please contact us at support@spookhost.eu.org for additional information and guidance for accessing, updating, or deleting data. </p>
							...
							<p>If you have any questions about the security or retention of your personal data, you can contact us at support@spookhost.eu.org.</p>
							...
							<p>If you have any questions, concerns or complaints about our Privacy Policy, our practices, or our Services, you may contact our Office of the DPO by contacting us at support@spookhost.eu.org. </p>
							<ul>
			...
			<p class="text-muted text-center py-2">
		    	&copy; Copyright <?= date('Y') ?> Spookhost
		    </p>
		</div>
	</div>
	<script type="text/javascript">
		...
		window.onload = function(){
			document.getElementById('DefaultClicked').click();
               ...
               if (option == "privacy") {
                document.querySelector("body > div > div > div.card.card-md > div > div > div.tabs.pb-3 > button:nth-child(2)").click();
               }
		}
	</script>
