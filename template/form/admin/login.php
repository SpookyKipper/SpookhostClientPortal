<?= form_open('a/login', ['class' => 'card card-md']) ?>
	<div class="card-body">
		...
		<?php if($this->grc->is_active()):?>
			<div class="mb-2">                    <div class="cf-turnstile" data-sitekey="<?= $this->grc->get_site_key();?>" data-callback="javascriptCallback"></div>
...
</form>	<script src="https://challenges.cloudflare.com/turnstile/v0/api.js?compat=recaptcha" async defer></script>